...
//                        return true;
//                    }
//                    SongHandler.instance.setPlaylist(playlistDir);
//                    return true;
//                }
//                case "create": {
//                    if (split.length > 2) {
...
//                    SongHandler.instance.setPlaylistLoop(Config.getConfig().loopPlaylists);
...
//                    SongHandler.instance.setPlaylistShuffle(Config.getConfig().shufflePlaylists);
